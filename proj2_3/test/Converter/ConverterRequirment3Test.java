...
public class ConverterRequirment3Test {
    ...
    @Test
    public void goodMeasureTest() throws MeasureTypeNotRecognised, BadNumberOfArgumentsException {
    ...
    @Test(expected = MeasureTypeNotRecognised.class)
    public void measureNotSuporrtedTest2() throws MeasureTypeNotRecognised, BadNumberOfArgumentsException {
    ...
    @Test(expected = MeasureTypeNotRecognised.class)
    public void measureNameMispelledTest() throws MeasureTypeNotRecognised, BadNumberOfArgumentsException {
